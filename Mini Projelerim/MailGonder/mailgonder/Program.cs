...
namespace MailGonder
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string Attachment = @"C:\Users\admin\Dropbox\Projects\MailGonder\MailGonder\proje.txt";
            string[,] Recipents = {
            ...
            MailGonderici(Recipents, "Mail Gönder Proje", MsgBody, Attachment);
        }

        public static void MailGonderici(string[,] To,string Subject, string Body, string Attachment)
        {
